...
export default class Board extends Component {
    ...
    onMouseDown( event ) {
        if ( !$( event.target ).parents('.widget').length ) {
    ...
    render() {
        ...
        return (
            <div>
                <div id="board" tabIndex="1" ref="boardElement" style={ this.state.size } onClick={ ::this.onClick } onMouseDown={ ::this.onMouseDown }>
                    ...
                    { !this.state.isDrawing && this.state.backgroundDrawing ? <div className="board-drawing-background" style={ drawingBackgroundStyle } /> : null }
                    <div className="board-background" style={ boardBackgroundStyle }></div>
                </div>
